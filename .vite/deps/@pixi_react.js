...
import {
  Filter
} from "./chunk-VJASXKLJ.js";
import "./chunk-CBS7UKQU.js";
import {
  Cache,
  Graphics,
  TextStyle
  ...
  "node_modules/react-reconciler/cjs/react-reconciler.development.js"(exports2, module2) {
    ...
    if (true) {
      module2.exports = function $$$reconciler($$$hostConfig) {
        ...
        var beforeActiveInstanceBlur2 = $$$hostConfig.beforeActiveInstanceBlur;
        var afterActiveInstanceBlur2 = $$$hostConfig.afterActiveInstanceBlur;
        var preparePortalMount2 = $$$hostConfig.preparePortalMount;
        var prepareScopeUpdate2 = $$$hostConfig.prepareScopeUpdate;
        var getInstanceFromScope2 = $$$hostConfig.getInstanceFromScope;
...
// node_modules/@pixi/react/lib/helpers/switchInstance.mjs
function switchInstance(instance, type, newProps, fiber) {
  var _a2;
  const parent = (_a2 = instance.__pixireact) == null ? void 0 : _a2.parent;
  if (!parent) {
    return;
  }
...
// node_modules/@pixi/react/lib/helpers/getCurrentEventPriority.mjs
...
var reconciler = (0, import_react_reconciler.default)(reconcilerConfig);
  ...
  if (!root) {
    ...
    const render = async (children, applicationOptions) => {
      ...
      if (!applicationState.app.renderer && !applicationState.isInitialised && !applicationState.isInitialising) {
        ...
        (_a2 = options.onInit ?? onInit) == null ? void 0 : _a2(applicationState.app);
      }
      ...
      reconciler.updateContainer(
        (0, import_react2.createElement)(ContextProvider, { value: applicationState }, children),
        fiber,
        null,
        () => void 0
      );
...
var _a, _b;
var useIsomorphicLayoutEffect = typeof window !== "undefined" && (((_a = window.document) == null ? void 0 : _a.createElement) || ((_b = window.navigator) == null ? void 0 : _b.product) === "ReactNative") ? import_react3.useLayoutEffect : import_react3.useEffect;

// node_modules/@pixi/react/lib/components/Application.mjs
var originalDefaultTextStyle = { ...TextStyle.defaultTextStyle };
var ApplicationFunction = (props, forwardedRef) => {
  const {
    attachToDevTools,
    children,
    className,
  ...
  const applicationRef = (0, import_react4.useRef)(null);
  const canvasRef = (0, import_react4.useRef)(null);
  const extensionsRef = (0, import_react4.useRef)(/* @__PURE__ */ new Set());
  const rootRef = (0, import_react4.useRef)(null);
  const updateResizeTo = (0, import_react4.useCallback)(() => {
  ...
  const handleInit = (0, import_react4.useCallback)((application) => {
  ...
  return (0, import_react4.createElement)("canvas", {
    ref: canvasRef,
    className
  });
};
ApplicationFunction.displayName = "Application";
var Application2 = (0, import_react4.forwardRef)(ApplicationFunction);

// node_modules/@pixi/react/lib/constants/UseAssetsStatus.mjs
var UseAssetsStatus = {
  ERROR: "error",
  PENDING: "pending",
  SUCCESS: "success"
...
// node_modules/@pixi/react/lib/hooks/useApp.mjs
var import_react5 = __toESM(require_react(), 1);
function useApp() {
  const { app } = (0, import_react5.useContext)(Context);
  invariant(
...
function useApplication() {
  const appContext = (0, import_react6.useContext)(Context);
  invariant(
...
// node_modules/@pixi/react/lib/helpers/getAssetKey.mjs
...
// node_modules/@pixi/react/lib/hooks/useAsset.mjs
...
// node_modules/@pixi/react/lib/hooks/useAssets.mjs
var import_react7 = __toESM(require_react(), 1);
var errorCache2 = /* @__PURE__ */ new Map();
...
function useAssets(assets, options = {}) {
  ...
  if (!allAssetsAreLoaded) {
    let cachedState = errorCache2.get(assets);
    if (cachedState && (!retryOnFailure || cachedState.retries > maxRetries)) {
      ...
      setState((previousState) => ({
        ...previousState,
        error: cachedState == null ? void 0 : cachedState.error,
        isError: true,
        isPending: false,
        isSuccess: false,
...
// node_modules/@pixi/react/lib/hooks/useSuspenseAssets.mjs
var errorCache3 = /* @__PURE__ */ new Map();
function assetsLoadedTest2(asset) {
  return Cache.has(getAssetKey(asset));
}
function useSuspenseAssets(assets, options = {}) {
  ...
  const allAssetsAreLoaded = assets.some(assetsLoadedTest2);
  if (!allAssetsAreLoaded) {
    let cachedState = errorCache3.get(assets);
    if (cachedState && (!retryOnFailure || cachedState.retries > maxRetries)) {
      if (typeof onError === "function") {
        onError(cachedState.error);
      } else {
